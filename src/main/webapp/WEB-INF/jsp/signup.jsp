...
<%--			<p style="align-items: center;font-size: 15px;">Enter if you are a COACH PLAYER OR JUST A USER:</p>--%>
			<input class="inputs" placeholder="Enter Role" name="role"></input>
<%--		<button class="btn btn-info role-buttons" name="COACH">COACH</button>--%>
<%--		<button class="btn btn-info role-buttons" name="PLAYER">PLAYER</button>--%>
        </div>
		...
		<a class="login" href="/login">Do you already have an account? LOGIN</a>
	</form>
</body>
</html>

<%--		<button onclick=${role.setRole("COACH")}>COACH</button>--%>
<%--		<button onclick=${role.setRole("PLAYER")}>PLAYER</button>--%>
<%--		<button onclick="${role.setRole("USER")}">USER</button>--%>